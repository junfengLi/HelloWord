(function(a, c) {
	var b = function(e, d) {
		...
		this.$element.on("click", ".tree-folder-header div", a.proxy(function(f) {
	...
	b.prototype = {
		...
		selectItem : function(e) {
			...
			this.$element.find("div").removeClass('myselected');
			d.addClass('myselected');
			
			if (this.options.selecshow == true) {
				...
				this.$element.trigger("extend", d.data())
			}
