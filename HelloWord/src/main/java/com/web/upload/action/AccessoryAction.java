...
public class AccessoryAction {
	...
	@ResponseBody
    public String editorUpload(HttpServletRequest request, HttpServletResponse response) {
                ...
                while (itr.hasNext()) {
                	...
                	if (!item.isFormField()) {
                		...
                		if(item.getSize() > maxSize){
                			...
                			return "error上传文件大小超过"+ Math.floor(maxSize/(1024*1024)) +"M限制。";
                		}
                		//检查扩展名
                		...
                		try{
                			...
                			logger.info("图片上传文件失败。");
                			return "error图片上传文件失败.";
                		}
                		return url;
                	}
                }
